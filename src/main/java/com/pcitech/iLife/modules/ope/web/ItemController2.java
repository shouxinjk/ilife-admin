 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/ope/item2")
public class ItemController2 extends BaseController {
	@Autowired
...
//		return "modules/ope/itemList";
		...
		return "redirect:http://www.shouxinjk.net/list-admin/index-metrics.html?classify="+treeId+categoryName+brokerId;//直接跳转到商品标注界面，需要保留header显示，提供搜索及排序功能
	}
...
//			}
	...
	public String index(Model model) {
		...
		model.addAttribute("url","ope/item2");
	...
	public String none(Model model) {
		...
		return "redirect:http://www.shouxinjk.net/list-admin/index-metrics.html?classify=all&classifyName=-&showAllItems=true"+brokerId;//默认显示首页
	}
}