...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/wx/wxPaymentAd/">广告购买记录列表</a></li>
		<li class="active"><a href="${ctx}/wx/wxPaymentAd/form?id=${wxPaymentAd.id}">广告购买记录<shiro:hasPermission name="wx:wxPaymentAd:edit">${not empty wxPaymentAd.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="wx:wxPaymentAd:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wxPaymentAd" action="${ctx}/wx/wxPaymentAd/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="subjectId" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>		
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="wx:wxPaymentAd:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
