...
<body>
	...
	<form:form id="inputForm" modelAttribute="personaMeasure" action="${ctx}/mod/personaMeasure/save" method="post" class="form-horizontal">
		...
		<div style="display:flex;flex-direction:row;flex-wrap:nowrap">
			<div style="width:50%">		
				...
				<div class="control-group">
					...
					<div class="controls">
						<form:textarea path="expression" htmlEscape="false" rows="3" maxlength="1024" class="input-xlarge "/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">偏好表达式：</label>
					<div class="controls">
						<form:textarea path="lambda" htmlEscape="false" rows="3" maxlength="1024" class="input-xlarge "/>
					</div>
				</div>
				<!--div class="control-group">
		...
		<div style="width:25%;border-left:1px solid silver; ">	
			...
			<div id="slider-alpha" data-slider-value="${personaMeasure.alpha}" style="width:90%;margin:10px;"></div>
			<div id="slider-beta" data-slider-value="${personaMeasure.beta}" style="width:90%;margin:10px;"></div>
			<div id="slider-gamma" data-slider-value="${personaMeasure.gamma}" style="width:90%;margin:10px;"></div>
