...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mod/tagCategory/">标签分类列表</a></li>
		<li class="active"><a href="${ctx}/mod/tagCategory/form?id=${tagCategory.id}&parent.id=${tagCategoryparent.id}">标签分类<shiro:hasPermission name="mod:tagCategory:edit">${not empty tagCategory.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mod:tagCategory:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tagCategory" action="${ctx}/mod/tagCategory/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="mod:tagCategory:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
