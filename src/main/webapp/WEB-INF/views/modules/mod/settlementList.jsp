...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mod/settlement/">结算管理列表</a></li>
		<shiro:hasPermission name="mod:settlement:edit"><li><a href="${ctx}/mod/settlement/form">结算管理添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="settlement">
			<tr>
				<td><a href="${ctx}/mod/settlement/form?id=${settlement.id}">
					<fmt:formatDate value="${settlement.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</a></td>
