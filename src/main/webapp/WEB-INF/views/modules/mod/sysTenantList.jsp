...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mod/sysTenant/">租户列表</a></li>
		<shiro:hasPermission name="mod:sysTenant:edit"><li><a href="${ctx}/mod/sysTenant/form">租户添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="sysTenant">
			<tr>
				...
				<shiro:hasPermission name="mod:sysTenant:edit"><td>
					...
					<a href="${ctx}/mod/sysTenant/delete?id=${sysTenant.id}" onclick="return confirmx('确认要删除该租户吗？', this.href)">删除</a>
