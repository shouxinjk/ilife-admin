	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnAddSelected").click(function(){
		        ...
		        $.ajax({
		            type: "POST",
		            url: "${ctx}/mod/occasionNeed/rest/batch",
		            dataType:"json",
		            ...
		            success:function(ret){
		                if(ret.success){
		                	...
		                	window.location = "${ctx}/mod/occasionNeed/?treeId=${pid}&treeModule=${pType}";
		                }else{
...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="mod:occasionNeed:edit"><li class="active"><a href="${ctx}/mod/occasionNeed/list2?treeId=${pid}&treeModule=${pType}">需要添加</a></li></shiro:hasPermission>
	</ul>
