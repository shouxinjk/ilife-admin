...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		<c:forEach items="${page.list}" var="userDimension">
			<tr>
				<td><a href="${ctx}/mod/userDimension/form?id=${userDimension.id}">
					${userDimension.name}
				</a></td>
				<td>
					<fmt:formatDate value="${userDimension.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<shiro:hasPermission name="mod:userDimension:edit"><td>
    				<a href="${ctx}/mod/userDimension/form?id=${userDimension.id}">修改</a>
					<a href="${ctx}/mod/userDimension/delete?id=${userDimension.id}" onclick="return confirmx('确认要删除该用户客观评价吗？', this.href)">删除</a>
