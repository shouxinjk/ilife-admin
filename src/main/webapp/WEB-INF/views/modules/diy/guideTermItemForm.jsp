	        ...
	        success:function(res){
	            ...
	            props.forEach(function(prop){
	            	...
	            	$("#prop"+prop.id).click(function(){
	            		...
	            		//填充到脚本区域
	            		$("#scriptDesc").val($("#scriptDesc").val()+" "+name);
	            	});
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/diy/guideTermItem/">指南规则条目关联列表</a></li>
		<li class="active"><a href="${ctx}/diy/guideTermItem/form?id=${guideTermItem.id}">指南规则条目关联<shiro:hasPermission name="diy:guideTermItem:edit">${not empty guideTermItem.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="diy:guideTermItem:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="guideTermItem" action="${ctx}/diy/guideTermItem/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<div style="display:flex;flex-direction:row;flex-wrap:nowrap">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="term.id" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">关联选项：</label>
			<div class="controls">
				<form:input path="item.id" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="diy:guideTermItem:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
