...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".performance-rating").each(function(index){
				...
				$("#rate-"+itemId).starRating({
				    ...
				    callback: function(currentRating, $el){
				        ...
				        console.log("dude, now try fuck me.[old]"+itemValue,itemId,currentRating);
				        $.ajax({
				            type: "GET",
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="performance">
			<tr>
				...
				<td>
					<div class="performance-rating" id="rate-${performance.id}" data-id="${performance.id}" data-markedValue="${performance.markedValue}"></div>
				</td>				
				<td>
